...
void declareEdgeSE2(py::module& m) {
    ...
    py::class_<EdgeSE2LotsOfXY, BaseMultiEdge<-1,VectorX>>(m, "EdgeSE2LotsOfXY")
        ...
        .def("set_measurement_from_state", &EdgeSE2LotsOfXY::setMeasurementFromState)
        .def("initial_estimate_possible", &EdgeSE2LotsOfXY::initialEstimatePossible)
    ...
    py::class_<EdgeSE2Offset, BaseBinaryEdge<3, SE2, VertexSE2, VertexSE2>>(m, "EdgeSE2Offset")
        ...
        .def("set_measurement_from_state", &EdgeSE2Offset::setMeasurementFromState)
    ...
    py::class_<EdgeSE2TwoPointsXY, BaseMultiEdge<4, Vector4>>(m, "EdgeSE2TwoPointsXY")
        ...
        .def("initial_estimate_possible", &EdgeSE2TwoPointsXY::initialEstimatePossible)
