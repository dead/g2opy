...
void declareEdgeSE2PointXY(py::module& m) {
    ...
    py::class_<EdgeSE2PointXY, BaseBinaryEdge<2, Vector2, VertexSE2, VertexPointXY>>(m, "EdgeSE2PointXY")
        ...
        .def("set_measurement_from_state", &EdgeSE2PointXY::setMeasurementFromState)
        .def("initial_estimate_possible", &EdgeSE2PointXY::initialEstimatePossible)
    ...
    templatedBaseBinaryEdge<1, double, VertexSE2, VertexPointXY>(m, "_1_double_VertexSE2_VertexPointXY");
    py::class_<EdgeSE2PointXYBearing, BaseBinaryEdge<1, double, VertexSE2, VertexPointXY>>(m, "EdgeSE2PointXYBearing")
        .def(py::init<>())
        ...
        .def("measurement_dimension", &EdgeSE2PointXYBearing::measurementDimension)
        .def("set_measurement_from_state", &EdgeSE2PointXYBearing::setMeasurementFromState)
        .def("initial_estimate_possible", &EdgeSE2PointXYBearing::initialEstimatePossible)
    ...
    py::class_<EdgeSE2PointXYOffset, BaseBinaryEdge<2, Vector2, VertexSE2, VertexPointXY>>(m, "EdgeSE2PointXYOffset")
        ...
        .def("set_measurement_from_state", &EdgeSE2PointXYOffset::setMeasurementFromState)
        .def("initial_estimate_possible", &EdgeSE2PointXYOffset::initialEstimatePossible)
